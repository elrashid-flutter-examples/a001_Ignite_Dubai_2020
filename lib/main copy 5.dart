...
//       Text(dateStr),
//       Flexible(
//         child: _build4(context, index, sessionGroup),
//       ),
//     ]);
//   }

//   ListView _build4(BuildContext context, int index, SessionGroup sessionGroup) {
//     return ListView.builder(
//       padding: const EdgeInsets.all(8),
//       itemCount: sessionGroup.sessions.length,
//       itemBuilder: (BuildContext context, int index) {
//         return _build3(context, index, sessionGroup.sessions);
//       },
//     );
//   }
